...
export default function ContactSection() {
  ...
  return (
    <section className="relative w-full  max-w-7xl mx-auto overflow-hidden py-20 px-6 lg:px-16 min-h-screen flex items-center"
      style={{
    ...
    >
      ...
      <div className="absolute -bottom-25 -left-18 w-[440px] h-[440px] rounded-full border-[28px] border-white z-0" />
      ...
      <div className="relative z-10 w-full flex flex-col lg:flex-row  gap-12 lg:gap-16">
        ...
        <div className="lg:w-1/2 bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Submit button */}
            <button
              className="flex items-center gap-2 bg-[#1E6FD9] hover:bg-blue-600 active:bg-blue-700 transition-colors text-white font-semibold px-6 py-3 rounded-xl w-fit mt-1"
            >
