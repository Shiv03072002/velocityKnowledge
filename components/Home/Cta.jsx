...
//                   className="bg-white/10 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-white  text-sm focus:outline-none focus:border-blue-500 transition-colors"
//                 />
//                 <input
//                   type="email"
//                   name="email"
...
//                 value={form.message}
//                 onChange={handleChange}
//                 className="bg-white/10 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-white  text-sm focus:outline-none focus:border-blue-500 transition-colors resize-none"
//               />
...
//               {/* Submit button */}
//               <button className="flex items-center gap-2 bg-[#1E6FD9] hover:bg-blue-600 active:bg-blue-700 transition-colors text-white font-semibold px-6 py-3 rounded-lg w-full lg:w-fit mt-1 justify-center lg:justify-start">
  ...
  return (
    <div className="bg-gray-50 py-16">
      ...
      >
        ...
        <div className="hidden md:block absolute -bottom-25 -left-50 w-[440px] h-[440px] z-0">
          <Image
            src="/images/cta/Group 179.png" // Replace with your actual image path
        ...
        <div className="relative z-10 w-full flex flex-col lg:flex-row gap-12 lg:gap-16">
          {/* Left content */}
          <div className="lg:w-1/2 text-white text-center lg:text-left">
            <div className="flex gap-2 mb-6 justify-center items-center lg:justify-start">
              <div className="w-3 h-3 bg-[#1E6FD9]" />
            ...
            <h2 className="text-4xl lg:text-5xl font-medium leading-tight mb-6 [font-family:var(--font-dm-serif)]">
              Let's build skills that matter
            </h2>
