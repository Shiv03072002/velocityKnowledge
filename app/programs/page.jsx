...
export default function Training() {
  ...
  const fetchPrograms = useCallback(async (search = "") => {
    setLoading(true);
    try {
      let url = "https://velocityknowledge.com/wp-json/wp/v2/course?per_page=20";
      
      // Add search parameter if search term exists
      if (search) {
        url = `https://velocityknowledge.com/wp-json/wp/v2/course?search=${encodeURIComponent(search)}&per_page=20`;
      }
  ...
  }, [debouncedSearchTerm, fetchPrograms]);
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-gray-600 text-lg">
                  {searchTerm ? `Searching for "${searchTerm}"...` : "Loading programs..."}
                </p>
              </div>
            ) : (
              <>
